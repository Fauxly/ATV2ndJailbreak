...
class ProcessRunner {
    ...
    func run(
        ...
        env["PYTHONPATH"] = (env["PYTHONPATH"] ?? "") + ":/usr/local/lib/python3.14/site-packages:/opt/homebrew/lib/python3.14/site-packages"
        env["DYLD_FALLBACK_LIBRARY_PATH"] = "/usr/local/lib:/opt/homebrew/lib:/usr/lib"
        env["LIBUSB_LIBRARY_PATH"] = "/usr/local/lib:/opt/homebrew/lib"
